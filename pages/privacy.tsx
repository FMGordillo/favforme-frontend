  ...
  <>
    ...
    <p>
      <span>
        ...
        or otherwise access Content (including software), controlled by third
        parties. &nbsp;COMPANY is not responsible for the privacy practices of
        these or any other web sites or Content controlled by third parties, and
    ...
    <p>
      <span>
        ...
        visiting the Site, purchasing products or services from COMPANY or the
        Site, or otherwise using the Site, please note that any personally
        identifiable information that you provide to COMPANY may be transferred
    ...
    <p>
      <span>
        ...
        collect personally identifiable information from Users in a variety of
    ...
    <p>
      <span>
        ...
        information you enter during account registration, cookie and log file
        data is used to customize your experience on the Site. &nbsp;One type of
        cookie, known as a &ldquo;persistent&rdquo; cookie, is set once you have
        logged in to your Site account. &nbsp;The next time you visit our Site,
        the persistent cookie will allow us to recognize you as an existing User
        so you will not need to log in before using the Site. &nbsp;In order to
        access or change any of your private information, you must log in with
        your password even if your computer contains your persistent cookie.
        &nbsp;Additionally, if you log out of the Site you will need to re-enter
        your password the next time you visit in order to log in to your
        account. &nbsp;Another type of cookie, called a &ldquo;session&rdquo;
        cookie, is used to identify a particular visit to the Site.
    ...
    <p>
      <span>
        ...
        server you use to access the World Wide Web), your computer operating
        system and type of web browser you are using, as well as the name of
        your Internet service provider (ISP). &nbsp;This information is used to
        analyze overall trends to help us improve the Site. &nbsp;The linkage
        between your IP address and your personally identifiable information is
    ...
    <p>
      <span>
        ...
        certain general profile. &nbsp;To deliver these ads properly, the Site
        may include a file, called a web beacon, from these ad networks within
        pages served by the Site or implement other monitoring technologies so
        the networks may provide anonymous, aggregated auditing, research and
        reporting for advertisers as well as to target ads to you while you
        visit other web sites. &nbsp;These general targets may also be used by
        ad networks to display targeted ads on other web sites as a substitute
        for random, irrelevant ads. &nbsp;In addition, the Site may use the
        technology of ad networks to serve ads only when you visit this Site.
        &nbsp;Ad networks may use non-personal information, such as your state
        or zip code, in order to provide advertisements about goods and services
        that may be of particular interest to you while you visit this Site.
    ...
    <p>
      <span>
        ...
        with COMPANY. COMPANY may also use information collected through the
        Site for research regarding the effectiveness of the Site and the
        business planning, marketing, advertising and sales efforts of COMPANY,
    ...
    <p>
      <span>
        ...
        placed by you through the Site, and notices relating to the proper
      ...
      <span>
        ...
        we think you would appreciate receiving. To opt out of further
    ...
    <p>
      <span>
        ...
        the services offered by the Site and the Site itself, and for the
        specific purposes for which the information was collected. &nbsp;COMPANY
        may disclose personally identifiable information at the request of law
        enforcement or governmental agencies or in response to subpoenas, court
        orders or other legal process, to establish, protect or exercise
        COMPANY&rsquo;s legal or other rights, to defend against a legal claim
        or as otherwise allowed by law. &nbsp;COMPANY may disclose personally
        identifiable information in order to protect the rights, property or
        safety of a User or any other person. &nbsp;COMPANY may disclose
        personally identifiable information to investigate or prevent a
        violation by User of any contractual or other relationship with COMPANY
        or where COMPANY has a good faith belief that access, preservation or
        disclosure of such information is reasonably necessary to protect the
        rights, property or safety of COMPANY, its users or the public or the
        perpetration of any illegal or harmful activity. &nbsp;COMPANY may also
        disclose aggregate, anonymous data based on information collected from
        Users to Content developers, investors, advertisers and potential
    ...
    <p>
      <span>
        ...
        COMPANY cannot guarantee that the information submitted to, maintained
        on or transmitted from its systems will be completely secure.
        &nbsp;COMPANY is not responsible for the circumvention of any privacy
        settings or security measures contained on the Site by any Users or
        third parties.
      </span>
    </p>
    <p>
    ...
    <p>
      <span>
        ...
        that User&rsquo;s previously-provided personal data. &nbsp;This can be
        done by emailing a request to COMPANY at hello@favforme.com.
        &nbsp;Additionally, you may request access to the personally
        identifiable information as collected by COMPANY by sending a request to
        COMPANY as set forth above. &nbsp;Please note that in certain
        circumstances, COMPANY may not be able to completely remove a
        User&rsquo;s information from its systems. &nbsp;For example, COMPANY
        may retain a User&rsquo;s personal information for legitimate business
        purposes, if it may be necessary to prevent fraud or future abuse, for
        account recovery purposes, if required by law or as retained in
    ...
    <p>
      <a
        target="_blank"
        rel="noreferrer noopener"
        href="mailto:support@favforme.com"
      >
